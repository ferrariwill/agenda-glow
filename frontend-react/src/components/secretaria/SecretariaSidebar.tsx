...
const nav = [
  { to: '/secretaria/agenda', label: 'Agenda do Salão', icon: Calendar },
...
export const SecretariaSidebar = forwardRef<HTMLElement, Props>(
  function SecretariaSidebar({ mobileOpen = false, onNavigate }, ref) {
